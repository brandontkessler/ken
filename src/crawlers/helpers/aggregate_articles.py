...
def aggregate_articles(soup_articles, source, prepend_url=None):
    ...
    ArticleRecord = namedtuple('ArticleRecord', 'title, url, source')
    articles = []
    ...
    for article in soup_articles:
        ...
        articles.append(ArticleRecord(article_title, article_url, source))
